...
loss = "output/model_12_" + dataset_chunk + "_loss.jpg"
accuracy = "output/model_12_" + dataset_chunk + "_accuracy.jpg"
...
pred_df.to_csv("output/" + dataset_number + "_" + dataset_chunk + "model_12_predictions.csv")
test_labels = pd.DataFrame(Y_test)
test_labels.to_csv("output/" + dataset_number + "_" + dataset_chunk + "model_12_predictions_labels.csv")
